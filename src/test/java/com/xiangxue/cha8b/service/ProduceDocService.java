package com.xiangxue.cha8b.service;

import java.util.HashMap;
import java.util.Map;
import java.util.Random;

import com.xiangxue.cha8b.assist.SL_Busi;
import com.xiangxue.cha8b.service.question.ParallelQstService;
import com.xiangxue.cha8b.service.question.SingleQstService;
...
public class ProduceDocService {
	...
	//异步生成
	public static String makeDocAsyn(SrcDocVo pendingDocVo) throws Exception {
		System.out.println("开始处理文档  "+pendingDocVo.getDocName());
